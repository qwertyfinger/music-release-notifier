...
import com.qwertyfinger.musicreleasetracker.events.ReleasesLoadedEvent;
...
//          not working on emulator
            ...
            /*if ((actionId == Constants.EXPLICIT_REFRESH ||
                !PreferenceManager.getDefaultSharedPreferences(context).getBoolean(SettingsFragment.WIFI_ONLY, false)
